...
export const ui = {
  fr: {
    ...
    'form.success': 'Message reçu. Nous revenons vers vous sous 24h ouvrées.',
    'form.error': "L'envoi a échoué. Écrivez-nous sur WhatsApp, nous répondons tout de suite.",
    ...
    'newsletter.success': 'Inscription enregistrée.',
    'newsletter.error': 'Inscription impossible pour le moment.',
  ...
  en: {
    ...
    'form.success': 'Message received. We get back to you within 24 business hours.',
    'form.error': 'Sending failed. Message us on WhatsApp, we answer right away.',
    ...
    'newsletter.error': 'Could not subscribe right now.',
  ...
  ar: {
    ...
    'form.success': 'تم استلام رسالتك. سنعود إليك خلال 24 ساعة عمل.',
    'form.error': 'تعذر الإرسال. راسلنا على واتساب، نرد فورًا.',
    ...
    'newsletter.success': 'تم تسجيل اشتراكك.',
    'newsletter.error': 'تعذر التسجيل حاليًا.',
